...
function ActionItem({
  ...
  return (
    <Button
      onClick={onClick}
      variant="ghost"
      className={`group relative h-auto p-0 overflow-hidden rounded-2xl lg:rounded-3xl border-0 bg-gradient-to-br ${gradientFrom} ${gradientTo} shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 flex-1 min-w-[160px]`}
    >
      {/* Shimmer overlay */}
